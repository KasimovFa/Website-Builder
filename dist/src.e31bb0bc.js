...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  function TitleBlock(value, options) {
    ...
    return _super.call(this, value, options); //при помощи super инициализируем наши свойство из класса родителя т.е. Block
  ...
  return TitleBlock;
}(Block); //наследуется от класса block
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(event) {
      ...
      var styles = event.target.styles.value; //получаем объект с value = text или title и стили

      var newBlock = type === 'text' // если тип текст,то обращаемся к классу ТextBlock иначе TitleBlock
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var site = new _site.Site('#site'); //передаем нащ селектор из index.html 
